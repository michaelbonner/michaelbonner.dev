    ...
    >
      <main className="container mx-auto px-8 py-12 flex items-center">
        <div className="prose dark:prose-invert mt-16">
          ...
          <div>
            <p>
              Your privacy is important to me. It is Michael Bonner&apos;s
              policy to respect your privacy regarding any information I may
              collect from you across our website,{" "}
              <Link href="/">
                <a>https://michaelbonner.dev/</a>
              </Link>
            ...
            <p>
              ...
              provide you with your requested service. What data I store,
              I&apos;ll protect within commercially acceptable means to prevent
              loss and theft, as well as unauthorized access, disclosure,
              copying, use or modification.
            </p>
            <p>
              I don&apos;t share any personally identifying information publicly
            ...
            <p>
              ...
              with the understanding that I may be unable to provide you with
            ...
            <p>
              ...
              have any questions about how I handle user data and personal
          ...
          <div>
            ...
            <ol type="a">
              <li>
                ...
                materials (information or software) on Michael Bonner&apos;s
                ...
                <ol type="i">
                  ...
                  <li>
                    ...
                    contained on Michael Bonner&apos;s website;
                  </li>
                  <li>
              ...
              <li>
                ...
                these restrictions and may be terminated by Bootpack Digital, at
            ...
            <ol type="a">
              <li>
                The materials on Michael Bonner&apos;s website are provided on
                an &lquo;as is&rquo; basis. Michael Bonner, makes no warranties,
              ...
              <li>
                Further, Michael Bonner, does not warrant or make any
            ...
            <h3>4. Limitations</h3>
            <p>
              In no event shall Michael Bonner, or its suppliers be liable for
              any damages (including, without limitation, damages for loss of
              data or profit, or due to business interruption) arising out of
              the use or inability to use the materials on Michael Bonner&apos;s
              website, even if Michael Bonner, or a Michael Bonner, authorized
            ...
            <p>
              The materials appearing on Michael Bonner&apos;s website could
              include technical, typographical, or photographic errors. Michael
              Bonner, does not warrant that any of the materials on its website
              are accurate, complete or current. Michael Bonner, may make
              changes to the materials contained on its website at any time
              without notice. However Michael Bonner, LLC does not make any
              commitment to update the materials.
            </p>
            <h3>6. Links</h3>
            <p>
              Michael Bonner, has not reviewed all of the sites linked to its
              website and is not responsible for the contents of any such linked
              site. The inclusion of any link does not imply endorsement by
              Michael Bonner, of the site. Use of any such linked website is at
              the user&apos;s own risk.
            </p>
            <h3>7. Modifications</h3>
            <p>
              Michael Bonner, may revise these terms of service for its website
