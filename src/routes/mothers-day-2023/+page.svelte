...
<div class="container mx-auto grid gap-8 px-8 py-12">
	<div class="prose dark:prose-invert mt-12">
		...
		<p>
			You've always been there for me, supporting me and believing in me no matter what. Your
			unwavering faith in my abilities has given me the strength to face challenges that come my
			way. I can't thank you enough for always having my back.
		</p>

		<p>
			You've taught me so much about life and how to be a good person. Your kindness, compassion,
			and generosity have shaped me into the person I am today. I strive to live up to your example
			and make you proud.
		</p>

		<p>
			I want you to know how grateful I am for everything you've done and continue to do for me.
			Your sacrifices and selflessness haven't gone unnoticed. You've given me incredible
			opportunities and experiences that have shaped my life in the best possible ways.
		</p>

		<p>
			Thank you for being the most amazing mom I could ever ask for. I love you more than words can
			express.
		</p>

		<p>Here's a recording I made for you of "Come Thou Fount." I hope you enjoy it 😀</p>

		<div class="mt-12 grid w-full justify-center lg:flex lg:items-center lg:justify-start lg:gap-8">
			<audio class="w-[80vw] lg:w-[340px]" controls>
				...
				/>
				<source
					src="https://mbonner-general-web.s3.us-west-2.amazonaws.com/Come-Thou-Fount.mp3"
					type="audio/mpeg"
				/>
