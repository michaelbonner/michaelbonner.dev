...
<main class="container flex items-center py-12 px-8 mx-auto">
	<div class="mt-16 prose dark:prose-invert">
		...
		<div>
			...
			<p>
				...
				collect it by fair and lawful means, with your knowledge and consent. I also let you know
				why I&apos;m collecting it and how it will be used.
			</p>
			<p>
				I only retain collected information for as long as necessary to provide you with your
				requested service. What data I store, I&apos;ll protect within commercially acceptable means
			...
			<p>
				Our website may link to external sites that are not operated by me. Please be aware that I
		...
		<div>
			...
			<ol type="a">
				<li>
					...
					software) on Michael Bonner&apos;s website for personal, non-commercial transitory viewing
					...
					<ol type="i">
						...
						<li>
							attempt to decompile or reverse engineer any software contained on Michael
							Bonner&apos;s website;
						</li>
				...
				<li>
					...
					may be terminated by Bootpack Digital, at any time. Upon terminating your viewing of these
			...
			<ol type="a">
				<li>
					The materials on Michael Bonner&apos;s website are provided on an &lquo;as is&rquo; basis.
					Michael Bonner, makes no warranties, expressed or implied, and hereby disclaims and
				...
				<li>
					Further, Michael Bonner, does not warrant or make any representations concerning the
			...
			<h3>4. Limitations</h3>
			<p>
				In no event shall Michael Bonner, or its suppliers be liable for any damages (including,
				without limitation, damages for loss of data or profit, or due to business interruption)
				arising out of the use or inability to use the materials on Michael Bonner&apos;s website,
				even if Michael Bonner, or a Michael Bonner, authorized representative has been notified
			...
			<p>
				The materials appearing on Michael Bonner&apos;s website could include technical,
				typographical, or photographic errors. Michael Bonner, does not warrant that any of the
				materials on its website are accurate, complete or current. Michael Bonner, may make changes
				to the materials contained on its website at any time without notice. However Michael
				Bonner, LLC does not make any commitment to update the materials.
			</p>
			<h3>6. Links</h3>
			<p>
				Michael Bonner, has not reviewed all of the sites linked to its website and is not
				responsible for the contents of any such linked site. The inclusion of any link does not
				imply endorsement by Michael Bonner, of the site. Use of any such linked website is at the
				user&apos;s own risk.
			</p>
			<h3>7. Modifications</h3>
			<p>
				Michael Bonner, may revise these terms of service for its website at any time without
